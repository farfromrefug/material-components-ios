...
Pod::Spec.new do |mdc|
  ...
  mdc.ios.deployment_target = '13.0'
  ...
  mdc.subspec "ActivityIndicator" do |component|
    ...
    component.dependency "MotionAnimator"
  ...
  mdc.subspec "AppBar+Theming" do |extension|
    extension.ios.deployment_target = '13.0'
    extension.public_header_files = "components/#{extension.base_name.split('+')[0]}/src/#{extension.base_name.split('+')[1]}/*.h"
    extension.source_files = "components/#{extension.base_name.split('+')[0]}/src/#{extension.base_name.split('+')[1]}/*.{h,m}", "components/#{extension.base_name.split('+')[0]}/src/#{extension.base_name.split('+')[1]}/private/*.{h,m}"
    extension.dependency "MaterialComponents/#{extension.base_name.split('+')[0]}"
    extension.dependency "MaterialComponents/schemes/Container"
  ...
  mdc.subspec "BottomNavigation" do |component|
    ...
    component.dependency "MaterialComponents/ShadowElevations"
    component.dependency "MaterialComponents/ShadowLayer"
    component.dependency "MaterialComponents/Badges"
   component.dependency   "MaterialComponents/Typography"
    component.dependency "MaterialComponents/private/Math"
  ...
  mdc.subspec "Buttons" do |component|
    component.public_header_files = ["components/#{component.base_name}/src/*.h", "components/M3CButton/src/*.h"]
    component.source_files = [
      "components/#{component.base_name}/src/*.{h,m}",
      "components/#{component.base_name}/src/private/*.{h,m}",
      "components/M3CButton/src/*.{h,m}",
      "components/M3CButton/src/private/*.{h,m}"
    ]
  ...
  mdc.subspec "Badges" do |component|
    component.public_header_files = "components/#{component.base_name}/src/*.h", "components/#{component.base_name}/src/Appearance/*.h"
    component.source_files = "components/#{component.base_name}/src/*.{h,m}", "components/#{component.base_name}/src/Appearance/*.{h,m}"
  ...
  mdc.subspec "Typography" do |component|
    ...
    component.source_files = [
      ...
      "components/#{component.base_name}/src/FontLoader/*.{h,m}",
      "components/#{component.base_name}/src/private/*.{h,m}"
    ]
